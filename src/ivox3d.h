...
class IVox {
   public:
    ...
    struct Options {
        Options(double resolution = 0.2, double inv_resolution = 10.0, int nearby_type = 1, int capacity = 1000000)
            : resolution_(resolution), inv_resolution_(inv_resolution), capacity_(capacity) {
